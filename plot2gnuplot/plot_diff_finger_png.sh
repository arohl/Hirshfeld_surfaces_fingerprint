...
#
# chmod u+x plot_diff_finger_png.sh      # provision of the executable bit
# ./plot_diff_finger_png.sh example.dat  # generation of the .png plot
#
